...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Juliao Gime", "juliaogimi@gmail.com", new DateTime(1996, 06,10), 10000.0, d1);
            Seller s3 = new Seller(3, "Paulo Vuvo", "pv@gmail.com", new DateTime(1992, 03, 07), 1000.0, d4);
            Seller s4 = new Seller(4, "Ivo Branco", "ivo@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s5 = new Seller(5, "Serafina Gomes", "serafina@gmail.com", new DateTime(2000, 08, 23), 1000.0, d3);
            Seller s6 = new Seller(6, "Isaac Lubaki", "isaac@gmail.com", new DateTime(1995, 5, 25), 1000.0, d2);
